...
REGISTRY: dict[str, TaskSpec] = {
    ...
    "bench_secbench_en": TaskSpec(
        type="bench_secbench_en",
        label="Bench: SecBench EN (capability)",
        script="bench_run.py",
        runner_mode="subprocess",
        produces_artifact="report",
        consumes_artifact="adapter",
        ...
        gauntlet_member=True,
        implemented=True,
        description="Capability - SecBench English MCQ (MIT, fetched)",
    ),
    "bench_seceval": TaskSpec(
        type="bench_seceval",
        label="Bench: SecEval (capability)",
        script="bench_run.py",
        runner_mode="subprocess",
        produces_artifact="report",
        consumes_artifact="adapter",
        ...
        gauntlet_member=True,
        implemented=True,
        description="Capability - SecEval multi-select MCQ (CC BY-NC-SA, fetched)",
    ),
    "bench_applied_attack": TaskSpec(
        type="bench_applied_attack",
        label="Bench: Applied ATT&CK (capability + posture)",
        script="bench_run.py",
        runner_mode="subprocess",
        produces_artifact="report",
        consumes_artifact="adapter",
        ...
        gauntlet_member=True,
        implemented=True,
        description="Layer 1 authored ATT&CK set (MIT, in-repo) - capability AND posture",
    ),
