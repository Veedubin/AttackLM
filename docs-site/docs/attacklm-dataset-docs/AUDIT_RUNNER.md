...
# Config
PYTHON="/home/Veedubin/Projects/reverse_engineering/AttackLM/.venv/bin/python"
MODEL="/home/Veedubin/Projects/reverse_engineering/AttackLM/uncensored"
DATASET_ROOT="/home/Veedubin/Projects/reverse_engineering/attacklm-dataset/data/datasets/buckets/sources"
AUDIT_ROOT="/home/Veedubin/Projects/reverse_engineering/attacklm-dataset/data/audit"
...
```bash
cd /home/Veedubin/Projects/reverse_engineering/attacklm-dataset
...
1. Verify all 4 output dirs have `summary.json`:
   ```bash
   ls -la /home/Veedubin/Projects/reverse_engineering/attacklm-dataset/data/audit/2026-07-08*/
   ```
